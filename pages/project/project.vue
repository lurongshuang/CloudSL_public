				...
				<view slot="state" class="list-wrap">
					<u-cell-group :border="false" style="background-color: #f5f4f4;">
						<u-cell-item v-for="(item, index) in listData" :key="index" style="padding: 0upx;" hover-class="cell-hover-class" :arrow="false">
							<view slot="label">
								<view class=" u-font-32 u-padding-20 text-bold text-black" style="line-height: 50upx;">{{ item.PRJNM }}</view>
								<u-line></u-line>
								<view style="padding: 25upx 15upx;">
									<u-row>
										<u-col class="u-font-30 text-gray" span="3">类别</u-col>
										<u-col class="u-font-30 text-black text-bold" span="9">{{ item.JTEXT }}</u-col>
									</u-row>
									<u-row class="u-m-t-10">
										<u-col class="u-font-30 text-gray" span="3">状态</u-col>
										<u-col class="u-font-30 text-black text-bold" span="9">{{ item.STEXT }}</u-col>
									</u-row>
								</view>
