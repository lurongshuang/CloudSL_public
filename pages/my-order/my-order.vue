				...
				<view slot="state" class="list-wrap">
					<u-cell-group :border="false" style="background-color: #f5f4f4;">
						<u-cell-item @click="itemClick()" v-for="(item,index) in listData" :key="index" style="padding: 0upx;" hover-class="cell-hover-class" :arrow="false">
							<view slot="label">
								<view class=" u-font-32 u-padding-20 text-bold text-black">土石坝养护修理规程</view>
								<u-line></u-line>
								<view style="padding: 25upx 15upx; line-height: 50upx;">
									<u-row>
										<u-col class="u-font-30 text-gray" span="3">订单金额</u-col>
										<u-col class="u-font-30 text-red text-bold" span="9">￥9.9</u-col>
									</u-row>
									<u-row class="u-m-t-10">
										<u-col class="u-font-30 text-gray" span="3">订单类别</u-col>
										<u-col class="u-font-30 text-black text-bold" span="9">水利标准</u-col>
									</u-row>
									<u-row class="u-m-t-10">
										<u-col class="u-font-30 text-gray" span="3">下单时间</u-col>
										<u-col class="u-font-30 text-black text-bold" span="9">2021-01-02 17:14:10</u-col>
									</u-row>
									<u-row class="u-m-t-10">
										<u-col class="u-font-30 text-gray" span="3">订单编号</u-col>
										<u-col class="u-font-30 text-black text-bold" span="9">202101021714105446</u-col>
									</u-row>
								</view>
