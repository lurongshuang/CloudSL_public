<template>
	...
	>
		...
		<view class="mescroll-body-content mescroll-wxs-content" :style="{ transform: translateY, transition: transition }" :change:prop="wxsBiz.callObserver" :prop="callProp">
			...
			<view v-if="mescroll.optDown.use" class="mescroll-downwarp" :style="getStyle()">
...
export default {
	...
	methods: {
		getStyle() {
			return 'background-color: ' + this.mescroll.optDown.bgColor + ';  color:' + this.mescroll.optDown.textColor;
		},
	...
	created() {
		...
		if (sys.windowHeight) vm.windowHeight = sys.windowHeight - sys.statusBarHeight - 44;
